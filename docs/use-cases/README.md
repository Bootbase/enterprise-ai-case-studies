...
| UC-004 | Autonomous Contract Review and Risk Analysis | Document Processing | Cross-Industry | detailed | `document-processing/UC-004-contract-review-risk-analysis/` |
...
| UC-400 | Autonomous Knowledge Synthesis (Consulting Copilot) | Knowledge Management | Consulting | detailed | `knowledge-management/UC-400-knowledge-synthesis-consulting/` |
...
| UC-506 | Autonomous Telecom Network Operations | Industry-Specific | Telecommunications | detailed | `industry-specific/UC-506-telecom-network-operations/` |
| UC-507 | Autonomous Manufacturing Quality Inspection | Industry-Specific | Manufacturing | detailed | `industry-specific/UC-507-manufacturing-quality-inspection/` |
| UC-508 | Autonomous Dynamic Pricing and Revenue Optimization | Industry-Specific | Retail / E-Commerce | detailed | `industry-specific/UC-508-dynamic-pricing-optimization/` |
...
| UC-517 | Autonomous Water Network Leak Detection and Non-Revenue Water Reduction | Industry-Specific | Water / Utilities | research | `industry-specific/UC-517-water-network-leak-detection/` |
