...
| UC-041  | [Autonomous Regulatory Change Intelligence and Compliance Orchestration with Agentic AI](knowledge-management/UC-041-autonomous-regulatory-change-intelligence-agentic-ai/use-case.md) | Knowledge Management | Cross-Industry (Financial Services, Pharmaceutical, Healthcare, Energy, Insurance) | High | `research` |
