...
| UC-025  | [Autonomous Multi-Jurisdiction Tax Compliance and Filing with Agentic AI](workflow-automation/UC-025-autonomous-multi-jurisdiction-tax-compliance-agentic-ai/use-case.md) | Workflow Automation | Cross-Industry (Manufacturing, Retail, E-Commerce, Financial Services, Technology, Professional Services) | High | `detailed` |
