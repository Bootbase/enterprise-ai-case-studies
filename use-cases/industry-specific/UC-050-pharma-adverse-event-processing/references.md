# UC-050: Autonomous Adverse Event Report Processing in Pharmacovigilance — References

## Research Brief

| ID | Resource | Type | What It Covers | Link |
|----|----------|------|----------------|------|
| `UC` | UC-050 research brief | Local source | Problem statement, constraints, success criteria, and operating assumptions used for scenario calculations | [use-case.md](./use-case.md) |
...
| `EX3` | Azure AI Agents Java SDK samples | Java | Official examples for function-calling loops with Microsoft Foundry agents | https://github.com/Azure/azure-sdk-for-java/tree/main/sdk/ai/azure-ai-agents/src/samples/ |
| `EX4` | Azure .NET function-calling sample | C# | Official sample linked from Microsoft Foundry function-calling docs | https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/ai/Azure.AI.Extensions.OpenAI/samples/Sample9_Function.md |
...
| Scenario calculations in the other documents | Derived from `UC` plus the public percentage improvements in `CS2` and `CS3`; they are intentionally labeled `estimated`. |
