# UC-041: Autonomous Regulatory Change Intelligence and Compliance Orchestration with Agentic AI — References

## Research Brief

| ID | Resource | Type | What It Covers | Link |
|----|----------|------|----------------|------|
| `UC` | UC-041 research brief | Local source | Problem statement, constraints, success criteria, and operating assumptions used for scenario calculations | [use-case.md](./use-case.md) |
...
| `CS7` | C.H. Robinson: LangChain/LangGraph in production logistics | Logistics | Confirmed production use of LangChain for model interoperability, LangGraph for stateful classification tasks, LangSmith for observability — the same framework stack recommended for UC-041 | https://blog.langchain.com/customers-chrobinson/ |
...
| `AN5` | Riskonnect: A Comprehensive Guide to Regulatory Change Management | Industry guide | End-to-end RCM process description, industry best practices, technology requirements, GRC platform integration patterns | https://riskonnect.com/compliance/a-comprehensive-guide-to-regulatory-change-management/ |
...
| `AN13` | XTRAREG: LLM-assisted Extraction of Regulatory Requirements (RE 2025) | Academic | LLM + RAG for automated regulatory requirement extraction from GDPR; achieved 81.8% accuracy on Right of Access requirements; key finding: LLMs favor training data over RAG context — explicit citation grounding is necessary | https://conf.researchr.org/details/RE-2025/RE-2025-Research-Papers/12/ |
...
| `AN15` | Towards Reliable Retrieval in RAG for Legal Datasets (arXiv) | Academic | Summary-Augmented Chunking halves document retrieval mismatch for legal text; standard RAG had >95% document-level retrieval mismatch on legal documents; dense semantic search outperformed BM25 hybrid for legal text | https://arxiv.org/html/2510.06999v1 |
...
| `IN5` | DataMotion: Agentic AI in Regulated Industries — A Roadmap for Trust and Scale | Analysis | Challenges of deploying agentic AI in regulated industries: explainability, auditability, human oversight requirements; EU AI Act and ISO/IEC 42001 compliance considerations | https://datamotion.com/agentic-ai-regulated-industries/ |
| `IN6` | SS&C Blue Prism: AI Agents in Regulated Industries | Blog | AI agent deployment patterns for banking, insurance, healthcare; hybrid AI architectures with knowledge graph foundations for governance and explainability | https://www.blueprism.com/resources/blog/ai-agents-regulated-industries/ |
...
|----|------------|----------|----------------------|------|
| `EX1` | LangGraph | Python | Open-source graph orchestration runtime: StateGraph, conditional edges, human-in-the-loop interrupts, checkpointing — the recommended framework for UC-041's pipeline orchestration | https://github.com/langchain-ai/langgraph |
...
| `EX3` | kg-gen (Knowledge Graph Generation) | Python | NeurIPS '25: knowledge graph generation from any text; relevant to building regulation-obligation knowledge graphs | https://github.com/stair-lab/kg-gen |
...
| ID | Resource | Type | What It Covers | Link |
|----|----------|------|----------------|------|
| `RF1` | EU AI Act | Legislation | Comprehensive risk-based AI governance framework: documentation, transparency, human oversight, post-market monitoring; high-risk system obligations relevant to UC-041's own compliance | https://eur-lex.europa.eu/eli/reg/2024/1689 |
...
|-------------|-------|--------------|
| UC-040 | Autonomous Knowledge Synthesis and Research Copilot for Management Consultants with Agentic AI | Both are knowledge management use cases, but UC-040 focuses on internal proprietary knowledge (past engagement decks, research) while UC-041 focuses on external regulatory knowledge across jurisdictions. The RAG and multi-agent patterns are shared. |
| UC-052 | Autonomous M&A Due Diligence and Contract Review with Agentic Legal AI | Shares legal document analysis patterns: obligation extraction, deontic classification, cross-reference resolution. UC-052 targets contract review; UC-041 targets regulatory text. |
| UC-053 | Autonomous AML Alert Investigation with Agentic AI in Banking | Downstream consumer: AML compliance obligations are among the regulations UC-041 would monitor and extract. UC-053 operationalizes AML compliance; UC-041 ensures the obligation framework stays current. |
...
| Neo4j | 5.x | Official docs (knowledge graph) | https://neo4j.com/docs/ |
| feedparser | latest | Python RSS/Atom feed parser | https://feedparser.readthedocs.io/ |
